---
source: https://www.backtrader.com/docu/strategy-reference/
fetched: 2026-07-17
...
_Signals_ are usually indicators and the expected output values:
...
Orders execution type is `Market` and validity is `None` (_Good until Canceled_)
