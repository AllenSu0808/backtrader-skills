---
source: https://www.backtrader.com/docu/observers-reference/
fetched: 2026-07-17
title: "Observers - Reference"
---
...
This observer stores the _returns_ of the strategy and the _return_ of a reference asset which is one of the datas passed to the system.
...
Remember that at any moment of a `run` the current values can be checked by looking at the _lines_ by name at index `0`.
...
This observer stores the _returns_ of the strategy.
...
This observer stores the _log returns_ of the strategy or a
