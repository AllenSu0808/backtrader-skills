---
source: https://www.backtrader.com/docu/order-creation-execution/bracket/bracket/
fetched: 2026-07-17
title: "Orders - Brackets"
---
...
> Note
>
> This is implemented for _backtesting_ and for the _Interactivers Brokers_ store

A `bracket` order isn’s a single order but it is actually made up of _3_ orders. Let’s consider the long side
...
_backtrader_ offers two new methods in the `Strategy` to control _bracket_ orders.
...
*   In the 3rd case the main side order was completed and the high side (limit) was executed
    ...
    This can be noticed because the _Completed_ ids are `22` and `24` and the **high** side order is being issued last, which means the non-executed low side order has id 23.
    

Visually

[![image](../bracket.png)](https://www.backtrader.com/docu/order-creation-execution/bracket/bracket.png)
...
[![image](../bracket-buy_bracket.png)](https://www.backtrader.com/docu/order-creation-execution/bracket/bracket-buy_bracket.png)
