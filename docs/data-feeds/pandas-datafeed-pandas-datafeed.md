...
Supporting [Pandas](http://pandas.pydata.org) Dataframes seems to be of concern to lots of people, who rely on the already available parsing code for different data sources (including CSV) and other functionalities offered by Pandas.
...
[![image](../pandas-headers.png)](https://www.backtrader.com/docu/pandas-datafeed/pandas-headers.png)
