---
source: https://www.backtrader.com/docu/datafeed-develop-general/datafeed-develop-general/
fetched: 2026-07-17
title: "Data Feeds - Development - General"
---
...
[VisualChart](http://www.visualchart.com) can be downloaded free of charge for those interested in directly using the binary files.
...
The base class takes care of the parameters, initialization, opening of files, reading lines, splitting the lines in tokens and additional things like skipping lines which don’t fit into the date range (`fromdate`, `todate`) which the end user may have defined.
...
`backtrader` already defines a CSV datafeed (`VChartCSVData`) for the exports of [VisualChart](http://www.visualchart.com), but it is also possible to directly read the binary data files.
...
The Datafeed will be _started_ when backtesting commences (it can actually be started several times during optimizations)
...
[![image](../vchart-goog-2006.png)](https://www.backtrader.com/docu/datafeed-develop-general/vchart-goog-2006.png)
