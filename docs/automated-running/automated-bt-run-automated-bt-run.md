---
source: https://www.backtrader.com/docu/automated-bt-run/automated-bt-run/
fetched: 2026-07-17
title: "Automated Running"
---
...
One of the goals of _algorithmic trading_ is the automation of trading and given that backtrader is a _backtesting_ platform intented to check trading algorithms (hence is an _algotrading_ platform), automating the use of backtrader was an obvious goal.
...
[![image](../bt-run-mymod-no-params.png)](https://www.backtrader.com/docu/automated-bt-run/bt-run-mymod-no-params.png)
...
[![image](../bt-run-mymod-period-50.png)](https://www.backtrader.com/docu/automated-bt-run/bt-run-mymod-period-50.png)
...
`backtrader` will slowly be including sample (textbook) strategies. Along with the `bt-run.py` script a standard _Simple Moving Average CrossOver_ strategy is included. The name:
...
[![image](../bt-run-sma-crossover.png)](https://www.backtrader.com/docu/automated-bt-run/bt-run-sma-crossover.png)
...
[![image](../bt-run-sma-crossover-params-commission.png)](https://www.backtrader.com/docu/automated-bt-run/bt-run-sma-crossover-params-commission.png)
...
[![image](../bt-run-sma-crossover-sharpe.png)](https://www.backtrader.com/docu/automated-bt-run/bt-run-sma-crossover-sharpe.png)
...
[![image](../bt-run-observer-indicator.png)](https://www.backtrader.com/docu/automated-bt-run/bt-run-observer-indicator.png)
...
[![image](../bt-run-plot-candle.png)](https://www.backtrader.com/docu/automated-bt-run/bt-run-plot-candle.png)
