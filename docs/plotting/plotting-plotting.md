---
source: https://www.backtrader.com/docu/plotting/plotting/
fetched: 2026-07-17
title: "Plotting"
---
...
[![image](../01-sample-code.png)](https://www.backtrader.com/docu/plotting/01-sample-code.png)
...
*   `_fill_gt` / `_fill_lt`
    ...
    *   The 1st argument is a _string_ (name of reference line) or a numeric value
...
As the name implies, this is a _mixin_ class intended to be used in multiple inheritance schemes (specifically on the right hand side). The _mixin_ has no knowledge of the actual name of the 1st line (index is zero-based) from the other indicator that will be part of the multiple inheritance mix.
